        ...
        $('.players').on('click', function()
            {
                ...
                switch(val){
                    case "hvh":
                        $('#player1Icon').prop("src", 'public/img/human.jpg');
                        $('#player2Icon').prop("src", 'public/img/human.jpg');
                        global.playerOne.isHuman = true;
                        global.playerTwo.isHuman = true;
                        break;
                    case "hvia":
                        $('#player1Icon').prop("src", 'public/img/human.jpg');
                        $('#player2Icon').prop("src", 'public/img/ia.jpg');
                        global.playerOne.isHuman = true;
                        global.playerTwo.isHuman = false;
                        break;
                    case "iavia":
                        $('#player1Icon').prop("src", 'public/img/ia.jpg');
                        $('#player2Icon').prop("src", 'public/img/ia.jpg');
